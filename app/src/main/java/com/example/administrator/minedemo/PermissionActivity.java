...
public class PermissionActivity extends AppCompatActivity {
    ...
    private PermissionListener listener = new PermissionListener() {
        ...
        public void onSucceed(int requestCode, List<String> grantedPermissions) {
            ...
            if(requestCode == 100) {
                // TODO ...
                if(AndPermission.hasPermission(PermissionActivity.this, grantedPermissions)) {
                    // TODO 执行拥有权限时的下一步。
                } else {
                    // 使用AndPermission提供的默认设置dialog，用户点击确定后会打开App的设置页面让用户授权。
                    AndPermission.defaultSettingDialog(PermissionActivity.this, 200).show();
        ...
        public void onFailed(int requestCode, List<String> deniedPermissions) {
            ...
            if(requestCode == 100) {
                ...
                if(AndPermission.hasPermission(PermissionActivity.this, deniedPermissions)) {
                    // TODO 执行拥有权限时的下一步。
                } else {
                    // 使用AndPermission提供的默认设置dialog，用户点击确定后会打开App的设置页面让用户授权。
                    AndPermission.defaultSettingDialog(PermissionActivity.this, 200).show();
