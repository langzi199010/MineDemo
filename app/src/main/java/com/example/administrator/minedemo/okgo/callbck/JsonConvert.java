 ...
 */
package com.example.administrator.minedemo.okgo.callbck;


import com.example.administrator.minedemo.okgo.MyException;
...
//                }
                ...
                if (isSuccess) { //约定 正确返回码
                    return (T) responseBean;
                } else{
                    throw new MyException(""); //直接抛自定义异常  会出现在 callback的onError中
                }
