...
import com.example.administrator.minedemo.tools.Tools;
 ...
 */
public class PageGridView extends FeedRootRecyclerView {
    private int mRows = 0;
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            if (newState == 0) {
                if (!isAuto) {
                    ...
                    recyclerView.smoothScrollBy(Target - scrollX - currentPage * Tools.dp2px(getContext(), 15), 0);
                }
            } else if (newState == 2) {
                isAuto = false;
